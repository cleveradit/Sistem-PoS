...
Spesifikasi awal project, sumber kebenaran untuk scope dan desain sistem:

- **[PRD](initiate-file/01-prd.md)** — product requirements.
- **[Architecture](initiate-file/02-architecture.md)** — desain arsitektur sistem.
- **[Database Schema](initiate-file/03-database-schema.md)** — skema database.
- **[User Stories](initiate-file/04-user-stories.md)** — user stories.
- **[NFR](initiate-file/05-nfr.md)** — non-functional requirements.
